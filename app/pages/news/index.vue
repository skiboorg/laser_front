...
<template>
  ...
  <BlockSection :no_border="true" :show_title="true" title="Новости компании" >
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
      <div class="flex flex-col h-full" v-for="item in news?.results">
        <img class="w-full" :src="item.cover" alt="">
        <div class="flex flex-col flex-1 px-4 py-6 border-l border-r border-b border-[#E0E0E0]">
          ...
          <nuxt-link class="underline  mt-auto" :to="'/news/'+item.slug">Подробнее</nuxt-link>
        </div>
      </div>
    </div>
  </BlockSection>
