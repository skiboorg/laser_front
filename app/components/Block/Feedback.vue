    ...
    <BlockSection :no_border="true" :show_title="true" title="Отзывы наших клиентов" small_title="Отзывы" >
      ...
      <Carousel ref="carousel" v-bind="carouselConfig">
        <Slide v-for="i in reviews.results" class="flex flex-col items-start justify-start">
          <div class="px-5 py-7 border border-[#E0E0E0] min-h-[360px] flex flex-col items-start justify-between">
            <div class="flex flex-wrap gap-3 mb-7">
              <p class="px-2 py-1 bg-[#E8EBF6]" v-for="tag in i.tags_list">
                {{tag}}
              </p>
            </div>
            ...
            <div class="mt-auto" v-html="i.text"></div>
        </div>
        </Slide>
      </Carousel>
    </BlockSection>
