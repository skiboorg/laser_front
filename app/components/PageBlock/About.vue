  ...
  <BlockSection :show_title="false" class="text-white py-[88px] md:py-[120px]" style="background-image: url(/video.jpg)">
    ...
    <div class="grid grid-cols-1  md:grid-cols-12 pb-[60px] border-b border-[#B4B2B2] mb-6">
      ...
      <div class="hidden md:block col-span-3">
        <p class="text-lg font-medium leading-[120%] mb-6">
      ...
      <div class="hidden md:block col-span-3">
        <p class="text-lg font-medium leading-[120%] mb-6">
          Технологический преимущества<br>и разнообразие технологий
        </p>
        <p>
          Контроль качества в реальном времени – онлайн мониторинг процесса, обратная связь по мощности, скорости скана.
        </p>
      </div>
