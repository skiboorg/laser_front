...
<template>
 <BlockTop>
   <div class="flex flex-col items-start justify-center h-full xl:max-w-[740px] xl:border-l xl:border-r border-[#525252] px-10 xl:ml-40">
<!--     <div class="h-full w-[1px] border-l border-[#525252] absolute left-[20%]"></div>-->
     <div class="flex flex-wrap gap-2 mb-10">
       <UIBadge>Высокая скорость изготовления</UIBadge>
     ...
     <p class="text-white max-w-[370px] text-[16px] mb-24">Минимизируем простой оборудования, снижаем стоимость ремонта и повышаем надежность производственных процессов.</p>
      <div class="flex gap-3">
        ...
        <Button class="!text-white hover:!text-black" outlined severity="secondary" icon="pi pi-plus" icon-pos="right" label="Бесплатная консультация"/>
      </div>
   </div>
 </BlockTop>
